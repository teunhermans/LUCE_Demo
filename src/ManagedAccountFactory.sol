...
// Extensions
import ".deps/npm/@thirdweb-dev/dynamic-contracts/extension/upgradeable/PermissionsEnumberable.sol";
import ".deps/npm/@thirdweb-dev/dynamic-contracts/extension/upgradeable/ContractMetadata.sol";
...
contract ManagedAccountFactory is BaseAccountFactory, ContractMetadata, PermissionsEnumerable, BaseRouter {
    ...
    /*///////////////////////////////////////////////////////////////
                        External functions
    //////////////////////////////////////////////////////////////*/
    //function onRegistered() external {
    //
    //}
    /*///////////////////////////////////////////////////////////////
                            Internal functions
